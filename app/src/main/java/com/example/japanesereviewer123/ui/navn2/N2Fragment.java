    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        cardViewKanji.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                navController.navigate(R.id.action_n2Fragment_to_kanjiFragment, bundle);
            }
        });
        ...
        cardViewGrammar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Bundle bundle = new Bundle();
                bundle.putString("level","N2");
                navController.navigate(R.id.action_n2Fragment_to_grammarFragment, bundle);
            }
        });
        ...
        cardViewVocab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Bundle bundle = new Bundle();
                bundle.putString("level","N2");
                navController.navigate(R.id.action_n2Fragment_to_vocabFragment, bundle);
            }
        });
